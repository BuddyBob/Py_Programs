...
pygame.mixer.music.queue('music/music1.mp3')
#set up screen
screen = pygame.display.set_mode((600,600))
pygame.display.set_caption("Snake Game")
screen.fill((74, 66, 66))
#import a restart btn
colorWheel = pygame.image.load('Pictures/colorWheel.png')
colorWheel = pygame.transform.scale(colorWheel,(150,150))
restart = pygame.image.load('Pictures/restart.png')
restart = pygame.transform.scale(restart,(400,100))
musicMenue = pygame.image.load('Pictures/musicMenue.png')
musicMenue = pygame.transform.scale(musicMenue,(60,60))
leaderBoardButton = pygame.image.load('Pictures/leaderBoard.png')
...
def highscores(scores):
    ...
    highscore = scores[-1]
    return highscore
conn = sqlite3.connect('Snake/leaderboard.db')
#create cursor
c = conn.cursor()

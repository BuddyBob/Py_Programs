...
mixer.init()
volume = 0
mixer.music.load('/Users/aspera/Documents/Python/Py_Programs/games/Impossible_Snake_Game/music/music1.mp3') 
mixer.music.set_volume(volume) 
pygame.mixer.music.play(100) # repeat 5 times
pygame.mixer.music.queue('/Users/aspera/Documents/Python/Py_Programs/games/Impossible_Snake_Game/music/music1.mp3')
#set up screen
screen = pygame.display.set_mode((600,600))
pygame.display.set_caption("Snake Game")
screen.fill((74, 66, 66))
#import a restart btn
colorWheel = pygame.image.load('/Users/aspera/Documents/Python/Py_Programs/games/Impossible_Snake_Game/Pictures/colorWheel.png')
colorWheel = pygame.transform.scale(colorWheel,(150,150))
restart = pygame.image.load('/Users/aspera/Documents/Python/Py_Programs/games/Impossible_Snake_Game/Pictures/restart.png')
restart = pygame.transform.scale(restart,(400,100))
musicMenue = pygame.image.load('/Users/aspera/Documents/Python/Py_Programs/games/Impossible_Snake_Game/Pictures/musicMenue.png')
musicMenue = pygame.transform.scale(musicMenue,(60,60))
leaderBoardButton = pygame.image.load('/Users/aspera/Documents/Python/Py_Programs/games/Impossible_Snake_Game/Pictures/leaderBoard.png')
...
ft = '/Users/aspera/Documents/Python/Py_Programs/games/Impossible_Snake_Game/arial.ttf'
#*checkerboard
def funtext():
    ft = '/Users/aspera/Documents/Python/Py_Programs/games/Impossible_Snake_Game/arial.ttf'
    font = pygame.font.Font(ft, 50)
    # 33, 32, 28
...
def display_box(screen, message,backUp,innerBoxX,innerBoxY,outterBoxX,outterBoxY,textX,textY):
    ...
    fontobject = pygame.font.Font(ft,20)
...
def highscores(scores):
    ...
    highscore = scores[-1]
    return highscore
conn = sqlite3.connect('/Users/aspera/Documents/Python/Py_Programs/games/Impossible_Snake_Game/Snake/leaderboard.db')
#create cursor
c = conn.cursor()
...
#make sure leaderboard has enough slots for most peoplepython
with conn:
...
while gameover == False:
    ...
    smallfont = pygame.font.Font(ft, 20)
